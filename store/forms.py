...
class UserRegisterForm(forms.ModelForm):
    password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control green-input', 'placeholder': '••••••••'}))
    confirm_password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control green-input', 'placeholder': '••••••••'}))

    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'username', 'email']
        widgets = {
            'first_name': forms.TextInput(attrs={'class': 'form-control green-input', 'placeholder': 'John'}),
            'last_name': forms.TextInput(attrs={'class': 'form-control green-input', 'placeholder': 'Doe'}),
            'username': forms.TextInput(attrs={'class': 'form-control green-input', 'placeholder': 'johndoe'}),
            'email': forms.EmailInput(attrs={'class': 'form-control green-input', 'placeholder': 'john@example.com'}),
        }
